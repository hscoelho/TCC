...
\todo[inline]{
    em seguida ta o que foi escrito no tcc I, que acho que pode ser retirado
}
...
\todo[inline]{
tenho que esclarecer melhor sobre o trabalho antigo sobre localizacao
...
\todo[inline]{talvez eu fale aqui da configuração do filtro de kalman, e como
a mensagem da odometria ta com o sistema de coordenadas do twitst diferente do
esperado pelo filtro}
...
{\sourcecitation{Autor}}
\end{table}
\todo[inline]{quem sabe adicionar o tópico e tipo de mensagem na tabela?}
...
\missingfigure{seria legal uma tabela com os sistemas de localizacao}
