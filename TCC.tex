...
\todo{reescrever essa frase inicial se der tempo}
...
empregam técnicas diferentes para atualizar o mapa. \todo{nao achei
...
Optou-se por criar outro \textit{script} em \textit{bash} para gravar
os dados relevantes dos testes para análise posterior. Desta forma,
foi possível converter os dados da \textit{rosbag} para o formato
csv, que foi utilizado para criação de gráficos dos resultados.
