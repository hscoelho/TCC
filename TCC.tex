...
\begin{figure}[h]
    \caption{Posição estimada dos sistemas de odometria}
    \label{fig:odom}
    \begin{subfigure}{0.5\linewidth}
        {
            \centering
...
\todo[inline] {
    ...
    isso pode ser usado para explicar a diminuição do erro usando o 
    imu: 
    Finally, we note that to reduce overall odometry errors, 
orientation errors are the main source of concern because once 
they are incurred they grow without bound into lateral position 
errors [14], [19].

    também eu poderia fazer um gráfico do erro, parece que o erro
    da odometria das rodas é sistemático
}
