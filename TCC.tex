...
O planejamento realizado neste trabalho evidenciou um ponto essencial na
utilizou do ROS 2, a sua modularidade.
Isto permitiu a utilização de diversos pacotes de terceiros, aproveitando
o trabalho de outros desenvolvedores.
Além disso, o desenvolvimento do projeto pode ser efetuado gradualmente,
isolando cada funcionalidade em tópicos distintos, facilitando a comparação
de resultados de técnicas diferentes, como será feito com os pacotes de SLAM
e VSLAM.
...
modificações.
Além disso, para facilitar a reprodução deste trabalho, pode ser
